...
class SentenceSimilarity():
    ...
    def get_cuted_sentences(self):
        return [sentence.get_cuted_sentence() for sentence in self.sentences]
    ...
    def simple_model(self, min_frequency=1):
        ...
        self.texts = [[token for token in text if frequency[token]
                       > min_frequency] for text in self.texts]

        self.dictionary = corpora.Dictionary(self.texts)
        self.corpus_simple = [self.dictionary.doc2bow(
